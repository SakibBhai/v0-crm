...
function ProjectDetailsPage({ params }) {
    ...
    const createInvoiceFromData = (items, notes, isAuto)=>{
        ...
        return {
            id: `inv-${Date.now()}`,
            invoiceNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$invoices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInvoiceNumber"])(invoices),
            ...
            if (project.status === "completed" && project.billingType === "one-time") {
                ...
                if (!hasCompletionInvoice) {
                    ...
                    if (remainingAmount > 0) {
                        ...
                        ], `Auto-generated invoice upon project completion for ${project.name}.`, true);
                        setInvoices({
        ...
        "ProjectDetailsPage.useEffect": ()=>{
            if (project.billingType === "recurring" && project.monthlyRate && project.status !== "on-hold") {
                ...
                if (!hasThisMonthInvoice) {
                    ...
                    ], `Auto-generated monthly invoice for ${project.name}.`, true);
                    setInvoices({
                        "ProjectDetailsPage.useEffect": (prev)=>[
                                autoInvoice,
                                ...prev
...
_s(ProjectDetailsPage, "j2suZ8YVCvpFRb5zJruCWwCQ/VA=");
...
//# sourceMappingURL=_29a5f985._.js.map