...
function TasksPage() {
    ...
    const handleStatusChange = async (taskId, newStatus)=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$1e89ff__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateTask"])(taskId, {
                status: newStatus
            });
    ...
    const handleCloneTask = async (task)=>{
        try {
            ...
            const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$9012ec__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createTask"])({
                ...cloneData,
    ...
    const handleCreateTask = async (formData)=>{
        ...
        try {
            const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$9012ec__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createTask"])(taskData);
            if (created?.error) throw new Error(created.error);
            setTasks((prev)=>[
                    created,
                    ...prev
...
//# sourceMappingURL=app_1fbd8bc8._.js.map