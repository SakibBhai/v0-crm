...
async function getDashboardStats() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])("dashboard:stats:global", async ()=>{
        try {
...
async function getSuperAdminDashboardData() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])("dashboard:superadmin", async ()=>{
        try {
...
async function getManagementDashboardData() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])("dashboard:management", async ()=>{
        try {
...
async function getManagerDashboardData(managerName) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])(`dashboard:manager:${managerName || "all"}`, async ()=>{
        try {
...
async function getEmployeeDashboardData(employeeId, employeeName) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])(`dashboard:employee:${employeeId || "all"}`, async ()=>{
        try {
...
async function getClientDashboardData(clientId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cacheGet"])(`dashboard:client:${clientId || "all"}`, async ()=>{
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cdfa50b2._.js.map